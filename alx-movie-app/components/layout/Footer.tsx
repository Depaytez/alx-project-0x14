...
const Footer: React.FC = () => {
 return(
  <div className="container">
   <footer className="bg-[#171D22] text-white py-10 px-6 md:px-10 lg:px-20 footer-container">
    <div className="flex flex-col md:flex-row justify-between items-center w-full">
     ...
     <div className="flex space-x-4">
      ...
      <a href="https://facebook.com" target='_blank' className="hover:text-[#E2D609]" rel='noopener noreferrer'> 
    ...
    <div className="mt-8 text-center text-sm text-gray-400">
     <p>&copy; 2025 CineSeek by Philip Depaytez. All rights reserved.</p>
    </div>
   </footer>
  </div>
 );
